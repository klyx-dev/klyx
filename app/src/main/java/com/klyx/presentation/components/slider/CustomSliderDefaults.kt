...
/**
 * Object to hold defaults used by [com.klyx.presentation.components.slider.CustomSlider]
 */
@Stable
object CustomSliderDefaults {
     ...
     * [com.klyx.presentation.components.slider.CustomSlider] in different states.
     */
    @Composable
    fun colors() = colors(
    ...
    /**
     * The Default thumb for [com.klyx.presentation.components.slider.CustomSlider] and [CustomRangeSlider]
     *
    ...
    /**
     * The Default track for [com.klyx.presentation.components.slider.CustomSlider]
     *
