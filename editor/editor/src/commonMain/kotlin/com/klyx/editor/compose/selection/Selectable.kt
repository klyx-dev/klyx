...
/**
 * Provides [com.klyx.editor.compose.selection.Selection] information for a composable to SelectionContainer. Composables who can be
 * selected should subscribe to [com.klyx.editor.compose.selection.SelectionRegistrar] using this interface.
 */
internal interface Selectable {
    /**
     * An ID used by [com.klyx.editor.compose.selection.SelectionRegistrar] to identify this [Selectable]. This value should not be
     * [com.klyx.editor.compose.selection.SelectionRegistrar.Companion.InvalidSelectableId]. When a [Selectable] is created, it can request an
     * ID from [com.klyx.editor.compose.selection.SelectionRegistrar] by calling [com.klyx.editor.compose.selection.SelectionRegistrar.nextSelectableId].
     *
     * @see com.klyx.editor.compose.selection.SelectionRegistrar.nextSelectableId
     */
    val selectableId: Long

    /**
     * A function which adds [com.klyx.editor.compose.selection.SelectableInfo] representing this [Selectable] to the
     * [com.klyx.editor.compose.selection.SelectionLayoutBuilder].
     */
    fun appendSelectableInfoToBuilder(builder: SelectionLayoutBuilder)

    /**
     * Returns selectAll [com.klyx.editor.compose.selection.Selection] information for a selectable composable. If no selection can be
     * provided null should be returned.
     *
     * @return selectAll [com.klyx.editor.compose.selection.Selection] information for a selectable composable. If no selection can be
     *   provided null should be returned.
     */
     ...
     *
     * @param selection [com.klyx.editor.compose.selection.Selection] contains the [SelectionHandle]
