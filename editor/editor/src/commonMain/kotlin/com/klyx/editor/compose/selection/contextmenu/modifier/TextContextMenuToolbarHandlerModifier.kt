...
import com.klyx.editor.compose.selection.contextmenu.provider.LocalTextContextMenuToolbarProvider
 ...
 * [showTextContextMenu][com.klyx.editor.compose.selection.contextmenu.provider.TextContextMenuProvider.showTextContextMenu].
 *
...
internal class TextContextMenuToolbarHandlerNode(
    ...
    override fun contentBounds(destinationCoordinates: LayoutCoordinates): Rect {
        ...
        val computedContentBounds = computeContentBounds(destinationCoordinates) ?: return previousContentBounds
