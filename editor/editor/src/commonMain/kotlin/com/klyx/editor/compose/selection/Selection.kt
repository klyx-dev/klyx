...
internal data class Selection(
    ...
    internal data class AnchorInfo(
        ...
        /** The id of the [com.klyx.editor.compose.selection.Selectable] which contains this [Selection] Anchor. */
        val selectableId: Long,
    )

    fun merge(other: com.klyx.editor.compose.selection.Selection?): com.klyx.editor.compose.selection.Selection {
        if (other == null) return this

        val selection = this

        return if (handlesCrossed || other.handlesCrossed) {
            _root_ide_package_.com.klyx.editor.compose.selection.Selection(
