...
internal constructor(
    ...
    @Composable
        ...
        enabled: Boolean,
        colors: ContextMenuColors,
        leadingIcon: @Composable ((iconColor: Color) -> Unit)?,
        onClick: () -> Unit,
    ) -> Unit
) {
    ...
    fun item(
        ...
        composables += { colors ->
            ...
            itemUi(modifier, resolvedLabel, enabled, colors, leadingIcon, onClick)
        }
    }
...
@Composable
internal expect fun computeContextMenuColors(): ContextMenuColors
