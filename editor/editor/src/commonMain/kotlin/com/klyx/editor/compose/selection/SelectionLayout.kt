...
import com.klyx.editor.compose.selection.Direction.AFTER
import com.klyx.editor.compose.selection.Direction.BEFORE
import com.klyx.editor.compose.selection.Direction.ON
                ...
                Selection(
                    start =
                        Selection.AnchorInfo(
                            editorState.getTextDirectionForOffset(previousSelectionRange.start),
                            previousSelectionRange.start,
                            SingleSelectionLayout.DEFAULT_SELECTABLE_ID,
                        ),
                    end =
                        Selection.AnchorInfo(
                            editorState.getTextDirectionForOffset(previousSelectionRange.end),
 ...
 *   [isStartHandle]
 * @param containerCoordinates the coordinates of the [androidx.compose.foundation.text.selection.SelectionContainer] for converting
 *   [androidx.compose.foundation.text.selection.SelectionContainer] coordinates to their respective [Selectable] coordinates
...
internal class SelectableInfo(
    ...
    val inputText: String
        get() = editorState.content.toString()
    ...
    private val startRunDirection
        get() = editorState.getTextDirectionForOffset(rawStartHandleOffset)

    private val endRunDirection
        get() = editorState.getTextDirectionForOffset(rawEndHandleOffset)
    ...
    fun anchorForOffset(offset: Int): Selection.AnchorInfo =
        Selection.AnchorInfo(
            direction = editorState.getTextDirectionForOffset(offset),
            offset = offset,
            selectableId = selectableId,
        )
