...
import com.klyx.editor.compose.selection.TextClassifierHelperMethods.createTextClassificationSession
import com.klyx.editor.compose.selection.TextClassifierHelperMethods.hasLegacyAssistItem
import com.klyx.editor.compose.selection.TextClassifierHelperMethods.toAndroidLocaleList
import com.klyx.editor.compose.selection.contextmenu.addProcessedTextContextMenuItems
import com.klyx.editor.compose.selection.contextmenu.builder.TextContextMenuBuilderScope
import com.klyx.editor.compose.selection.contextmenu.builder.textClassificationItem
...
internal object TextClassifierHelperMethods {
    ...
    fun toAndroidLocaleList(localeList: LocaleList): android.os.LocaleList {
        return localeList.let { list ->
            android.os.LocaleList(*list.map { it.platformLocale }.toTypedArray())
        }
    }
