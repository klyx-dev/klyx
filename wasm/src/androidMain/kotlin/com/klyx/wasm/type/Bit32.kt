...
@OptIn(ExperimentalWasmApi::class)
@JvmInline
value class WasmInt(val value: Int) : WasmValue {
    override fun writeToBuffer(buffer: ByteArray, offset: Int) {
...
@OptIn(ExperimentalWasmApi::class)
@JvmInline
value class WasmFloat(val value: Float) : WasmValue {
    override fun writeToBuffer(buffer: ByteArray, offset: Int) {
