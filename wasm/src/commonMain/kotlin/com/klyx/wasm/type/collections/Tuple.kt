...
@JvmInline
value class Tuple2<A : WasmType, B : WasmType>(
    ...
    companion object {
        fun <A : WasmType, B : WasmType> reader(
...
@JvmInline
value class Tuple3<A : WasmType, B : WasmType, C : WasmType>(
    ...
    companion object {
        fun <A : WasmType, B : WasmType, C : WasmType> reader(
            firstReader: WasmMemoryReader<A>,
            secondReader: WasmMemoryReader<B>,
...
class Tuple2Reader<A : WasmType, B : WasmType>(
...
@OptIn(ExperimentalWasmApi::class)
class Tuple3Reader<A : WasmType, B : WasmType, C : WasmType>(
    private val firstReader: WasmMemoryReader<A>,
    private val secondReader: WasmMemoryReader<B>,
