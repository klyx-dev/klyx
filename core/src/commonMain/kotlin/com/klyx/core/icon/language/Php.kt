...
val KlyxIcons.Language.Php: ImageVector
    get() {
        if (_Php != null) {
            return _Php!!
        }
        _Php = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.556f, 0f, 0.97f, -0.105f, 1.242f, -0.314f)
                ...
                close()
                moveTo(12f, 5.688f)
                curveTo(5.373f, 5.688f, 0f, 8.514f, 0f, 12f)
                reflectiveCurveToRelative(5.373f, 6.313f, 12f, 6.313f)
                reflectiveCurveTo(24f, 15.486f, 24f, 12f)
                curveToRelative(0f, -3.486f, -5.373f, -6.312f, -12f, -6.312f)
                close()
                ...
                curveToRelative(0.797f, 0f, 1.378f, 0.209f, 1.744f, 0.628f)
                curveToRelative(0.366f, 0.418f, 0.476f, 1.002f, 0.33f, 1.752f)
                arcToRelative(2.836f, 2.836f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.305f, 0.847f)
                ...
                curveToRelative(0.767f, 0f, 1.295f, 0.134f, 1.586f, 0.401f)
                ...
                arcToRelative(2.782f, 2.782f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.305f, 0.847f)
                curveToRelative(-0.143f, 0.255f, -0.33f, 0.49f, -0.561f, 0.703f)
                arcToRelative(2.44f, 2.44f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.917f, 0.551f)
                ...
                horizontalLineToRelative(0.838f)
                curveToRelative(0.557f, 0f, 0.971f, -0.105f, 1.242f, -0.314f)
