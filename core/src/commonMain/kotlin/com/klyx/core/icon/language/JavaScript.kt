...
val KlyxIcons.Language.JavaScript: ImageVector
    get() {
        if (_JavaScript != null) {
            return _JavaScript!!
        }
        _JavaScript = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, 1.938f, -0.009f, 3.864f, -0.009f, 5.805f)
                curveToRelative(0f, 1.232f, 0.063f, 2.363f, -0.138f, 2.711f)
                ...
                curveToRelative(0.012f, -2.054f, 0f, -4.109f, 0f, -6.179f)
